    ...
    return (
        <Container className='history-container'>
            ...
            <p>
                ...
                story does start approximately two years ago browsing my favorite website 
                (at the time) <a href='#'>flippa.com</a>.  <p></p> <p></p> It was a website I come accustomed to because 
            ...
            <p>
                By this time I had bought an iOS app, “Math Guru – make math fun” ended up being a complete 
                ...
                entrepreneur to pull the trigger.  Things like <strong>6 Year Old domain</strong> - and here’s an 
                exact quote: 
                <Segment>
                    <p>
                ...
                <p></p> <p></p>
                    I snuck in a quick domain purchase <a href='#'>simpleknowledge.com</a> before my first success 
                    freelancertips.com.  Ohh the memories of rebuilding this thing from scratch using 
                    Wordpress.  
                <p></p> <p></p>
